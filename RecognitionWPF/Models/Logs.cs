...
namespace RecognitionWPF.Models
{
    public static class Logs
    {
        ...
        private static readonly string _directoryAdmin = $"{Environment.CurrentDirectory}\\Logs\\Admin\\{DateTime.Now.ToString("yyyy")}\\{GetMonth(DateTime.Now)}";
        private static readonly string _directoryUser = $"{Environment.CurrentDirectory}\\Logs\\User\\{DateTime.Now.ToString("yyyy")}\\{GetMonth(DateTime.Now)}";
        private static readonly string _fileNameAdmin = $"{_directoryAdmin}\\{DateTime.Now.ToString("dd - HH-mm-ss")}.txt";
        private static readonly string _fileNameUser = $"{_directoryUser}\\{DateTime.Now.ToString("dd - HH-mm-ss")}.txt";
