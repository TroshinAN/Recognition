...
namespace IntLabLibrary
{
    ...
    internal sealed class RecognitionContainer : Recognition
    {
        const string dll_file_name = "intlab.container.ire.x64.dll";
        static RecognitionContainer instance = null;
        static readonly object padlock = new object();

        public static RecognitionContainer GetInterface()
        {
            lock (padlock)
            {
                if (instance == null)
                {
                    instance = new RecognitionContainer();
                }
                return instance;
            }
        }
        ...
        private RecognitionContainer() : base(LibraryType.CONTAINER)
        { }

        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_LibraryInit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_LibraryFree", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_CreateAggregator", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_ReleaseAggregator", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_AddImageSource", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_Setup", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_Reset", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_Process", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_GetResult", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_CONTAINER_GetLastError", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
