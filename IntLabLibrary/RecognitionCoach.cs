...
namespace IntLabLibrary
{
    ...
    internal sealed class RecognitionCoach : Recognition
    {
        const string dll_file_name = "intlab.coach.ire.x64.dll";
        static RecognitionCoach instance = null;
        static readonly object padlock = new object();

        public static RecognitionCoach GetInterface()
        {
            lock (padlock)
            {
                instance = instance ?? new RecognitionCoach();
                return instance;
            }
        }

        private RecognitionCoach()
            : base(LibraryType.COACH)
        { }

        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_LibraryInit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_LibraryFree", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_CreateAggregator", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_ReleaseAggregator", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_AddImageSource", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_Setup", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_Reset", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_Process", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_GetResult", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_COACH_GetLastError", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
