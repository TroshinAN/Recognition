...
namespace IntLabLibrary
{
    ...
    internal sealed class RecognitionAutoMMR : Recognition
    {
        const string dll_file_name = "intlab.auto.mmr.ire.x64.dll";
        static RecognitionAutoMMR instance = null;
        static readonly object padlock = new object();

        public static RecognitionAutoMMR GetInterface()
        {
            lock (padlock)
            {
                instance = instance ?? new RecognitionAutoMMR();
                return instance;
            }
        }

        private RecognitionAutoMMR()
            : base(LibraryType.AUTO_MMR)
        { }

        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_LibraryInit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_LibraryFree", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_CreateAggregator", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_ReleaseAggregator", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_AddImageSource", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_Setup", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_Reset", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_Process", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_GetResult", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_MMR_GetLastError", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
