...
namespace IntLabLibrary
{
    ...
    internal sealed class RecognitionAutoLPR : Recognition
    {
        const string dll_file_name = "intlab.auto.lpr.ire.x64.dll";
        static RecognitionAutoLPR instance = null;
        static readonly object padlock = new object();

        public static RecognitionAutoLPR GetInterface()
        {
            lock (padlock)
            {
                instance = instance ?? new RecognitionAutoLPR();
                return instance;
            }
        }

        private RecognitionAutoLPR()
            : base(LibraryType.AUTO_LPR)
        { }

        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_LibraryInit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_LibraryFree", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_CreateAggregator", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_ReleaseAggregator", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_AddImageSource", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_Setup", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_Reset", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_Process", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_GetResult", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(dll_file_name, EntryPoint = "IRE_LPR_GetLastError", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
